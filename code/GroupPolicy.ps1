...
Get-GPO -Name "MSFT Internet Explorer 11 - Computer" | New-GPLink -Target $OU
Get-GPO -Name "MSFT Internet Explorer 11 - User" | New-GPLink -Target $OU
Get-GPO -Name "MSFT Windows 10 21H2 - BitLocker" | New-GPLink -Target $OU
Get-GPO -Name "MSFT Windows 10 21H2 - Computer" | New-GPLink -Target $OU
Get-GPO -Name "MSFT Windows 10 21H2 - Credential Guard" | New-GPLink -Target $OU
Get-GPO -Name "MSFT Windows 10 21H2 - Defender Antivirus" | New-GPLink -Target $OU
Get-GPO -Name "MSFT Windows 10 21H2 - Domain Security" | New-GPLink -Target $OU
Get-GPO -Name "MSFT Windows 10 21H2 - User" | New-GPLink -Target $OU
